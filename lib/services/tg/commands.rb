    ...
    class Commands
      ...
      def send_to_tg
        ...
        if (COMMANDS.include?(command))
          ...
          render partial: "respond", locals: { respond: response }
        end
      end
      ...
      def compose_payload
        { media: compose_media, chat_id: "-901342273" }
      end
      ...
      def add_upload(file)
        @uploads[file.original_filename] = Faraday::Multipart::FilePart.new(
          File.expand_path(file.tempfile),
          file.content_type
        )
      end
